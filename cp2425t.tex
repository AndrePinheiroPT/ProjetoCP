...
\column{4}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{sumV}\mathbin{::}\Conid{Vec}\;\Varid{a}\to \Conid{Int}\to \Conid{Vec}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{sumV}\;\Varid{v}\;\Varid{x}\mathrel{=}\Conid{V}\;(\map \;(\Varid{id}\times(\Varid{x}\mathbin{*}))\;(\Varid{outV}\;\Varid{v})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{miu}\mathbin{::}\Conid{Vec}\;(\Conid{Vec}\;\Varid{a})\to \Conid{Vec}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{miu}\mathrel{=}\Conid{V}\comp \Varid{concat}\comp \map \;(\Varid{outV}\comp \uncurry{\Varid{sumV}})\comp \Varid{outV}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mathbf{instance}\;\Conid{Monad}\;\Conid{Vec}\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
