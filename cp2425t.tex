...
Para o monad, vamos definir o $\mu$ (\ensuremath{\Varid{return}}) e o $\upsilon$ (\ensuremath{\Varid{miu}}) para facilitar na definição 
de outras funções
...
com o \ensuremath{\Varid{miu}} e \ensuremath{\mathsf{fmap}} definido, é simples definir \ensuremath{(\bind )}:
