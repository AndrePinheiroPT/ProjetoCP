...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{area}\;\Varid{l}\mathrel{=}(\Varid{min}\;(\Varid{head}\;\Varid{l})\;(\Varid{last}\;\Varid{l}))\mathbin{*}((\length \;\Varid{l})\mathbin{-}\mathrm{1}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
Portanto, o \textit{divide} desse anamorfismo é \ensuremath{(\Varid{id}\mathbin{+}\conj{\Varid{area}}{\Varid{cond}\;(\uncurry{(\mathbin{<})}\comp \conj{\Varid{head}}{\Varid{last}})\;\Varid{tail}\;\Varid{init}})\comp \Varid{out}}.
Resultando assim no diagrama do anamorfismo

\begin{eqnarray*}
\xymatrix{
    \ensuremath{{\N_0}^{*}}
           \ar[d]_-{\ensuremath{\Varid{bestAreas}\mathrel{=}\ana{\Varid{divide}}}}
           \ar[r]_-{\ensuremath{\Varid{divide}}}
&
	\ensuremath{\mathrm{1}\mathbin{+}\N_0\times{\N_0}^{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times\Varid{bestAreas}}}
\\
     \ensuremath{{\N_0}^{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\N_0\times{\N_0}^{*}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{maxList}\mathrel{=}\llparenthesis\, \alt{\Varid{zero}}{\uncurry{\Varid{max}}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

em que \ensuremath{\Varid{conquer}\mathrel{=}\alt{\Varid{zero}}{\uncurry{\Varid{max}}}}, é responsável por obter o maior valor numa lista de números não negativos,
podendo ser representado pelo seguinte diagrama

\begin{eqnarray*}
\xymatrix{
    \ensuremath{{\N_0}^{*}}
           \ar[d]_-{\ensuremath{\Varid{maxList}\mathrel{=}\llparenthesis\, \Varid{conquer}\,\rrparenthesis}}
           \ar[r]_-{\ensuremath{\Varid{out}}}
&
	\ensuremath{\mathrm{1}\mathbin{+}\N_0\times{\N_0}^{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{id}\times\Varid{maxList})}}
\\
    \ensuremath{\N_0}
&
    \ensuremath{\mathrm{1}\mathbin{+}\N_0\times\N_0}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{conquer}\mathrel{=}\alt{\Varid{zero}}{\uncurry{\Varid{max}}\comp (\Varid{fromIntegral}\times\Varid{fromIntegral})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mostwater}\mathrel{=}\Varid{hyloList}\;\Varid{conquer}\;\Varid{divide}{}\<[E]%
\\
\>[B]{}\Varid{divide}\mathrel{=}(\Varid{id}+\conj{\Varid{area}}{\Varid{cond}\;(\uncurry{(\mathbin{<})}\comp \conj{\Varid{head}}{\Varid{last}})\;\Varid{tail}\;\Varid{init}})\comp \Varid{outid}{}\<[E]%
\\
\>[B]{}\Varid{conquer}\mathrel{=}\alt{\underline{\mathrm{0}}}{\uncurry{\Varid{max}}\comp (\Varid{fromIntegral}\times\Varid{fromIntegral})}{}\<[E]%
\\
\>[B]{}\Varid{area}\;\Varid{l}\mathrel{=}(\Varid{min}\;(\Varid{head}\;\Varid{l})\;(\Varid{last}\;\Varid{l}))\mathbin{*}((\length \;\Varid{l})\mathbin{-}\mathrm{1}){}\<[E]%
\\
\>[B]{}\Varid{outid}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}i_1\;(){}\<[E]%
\\
\>[B]{}\Varid{outid}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}i_2\;(\Varid{h}\mathbin{:}\Varid{t}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\ensuremath{\Varid{myMapAccumR}\mathbin{::}((\Varid{a},\Varid{s})\to (\Varid{c},\Varid{s}))\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],\Varid{s})\to ([\mskip1.5mu \Varid{c}\mskip1.5mu],\Varid{s})}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outListAcc}\;([\mskip1.5mu \mskip1.5mu],\Varid{s}){}\<[23]%
\>[23]{}\mathrel{=}i_1\;((),\Varid{s}){}\<[E]%
\\
\>[B]{}\Varid{outListAcc}\;((\Varid{a}\mathbin{:}\Varid{x}),\Varid{s})\mathrel{=}i_2\;(\Varid{a},(\Varid{x},\Varid{s})){}\<[E]%
\\
\>[B]{}\llparenthesis\, \Varid{g}\,\rrparenthesis\mathrel{=}\Varid{g}\comp \Varid{recList}\;\llparenthesis\, \Varid{g}\,\rrparenthesis\comp \Varid{outListAcc}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
O que resulta neste diagrama:
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{{\Conid{A}}^{*}\times\Conid{S}}
           \ar[d]_-{\ensuremath{\Varid{myMapAccumR}\;\Varid{f}}}
           \ar[r]_-{\ensuremath{\Varid{outListAcc}}}
&
    \ensuremath{(\mathrm{1}\times\Conid{S})\mathbin{+}\Conid{A}\times({\Conid{A}}^{*}\times\Conid{S})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{myMapAccumR}\;\Varid{f})}}
\\
     \ensuremath{{\Conid{C}}^{*}\times\Conid{S}}
&
     \ensuremath{(\mathrm{1}\times\Conid{S})\mathbin{+}\Conid{A}\times({\Conid{C}}^{*}\times\Conid{S})}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
Falta apenas definir o gene deste catamorfismo.

myMapAccumR f = \ensuremath{\llparenthesis\, \alt{\Varid{myMapAccumR1}}{\Varid{myMapAccumR2}\;\Varid{f}}\,\rrparenthesis}

Seja o diagrama do \ensuremath{\Varid{myMapAccumR1}}:
\begin{eqnarray*}
\xymatrix@C=3cm{
     \ensuremath{\mathrm{1}\times\Conid{S}}
           \ar[r]^-{\ensuremath{\Varid{myMapAccumR1}}}
&
     \ensuremath{{\Conid{C}}^{*}\times\Conid{S}}
}
\end{eqnarray*}
O caso base do \ensuremath{\mapAccumR \;\Varid{f}\;([\mskip1.5mu \mskip1.5mu],\Varid{n})\mathrel{=}([\mskip1.5mu \mskip1.5mu],\Varid{n})}, logo
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{myMapAccumR1}\mathrel{=}\Varid{nil}\times\Varid{id}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
Para o \ensuremath{\Varid{myMapAccumR2}\;\Varid{f}}, iremos resolver passo a passo 
como está no diagrama a seguir
\begin{eqnarray*}
\xymatrix@C=2cm{
&
     \ensuremath{\Conid{A}\times({\Conid{C}}^{*}\times\Conid{S})}
           \ar[dl]_-{\ensuremath{\Varid{id}\times\p2}}
           \ar[dd]_-{\ensuremath{\conj{\Varid{f}\comp (\Varid{id}\times\p2)}{\p1\comp \p2}}}
           \ar[ddr]^-{\ensuremath{\p1\comp \p2}} 
\\
     \ensuremath{\Conid{A}\times\Conid{S}}
...
\\
     \ensuremath{\Conid{C}\times\Conid{S}}
&
     \ensuremath{(\Conid{C}\times\Conid{S})\times{\Conid{C}}^{*}}
           \ar[l]^-{\ensuremath{\p1}}
           \ar[d]_-{\ensuremath{\Varid{zed}\mathrel{=}\conj{\conj{\p1\comp \p1}{\p2}}{\p2\comp \p1}}}
           \ar[r]_-{\ensuremath{\p2}}
&
     \ensuremath{{\Conid{C}}^{*}}
\\ &
     \ensuremath{(\Conid{C}\times{\Conid{C}}^{*})\times\Conid{S}}
           \ar[d]_-{\ensuremath{\Varid{cons}\times\Varid{id}}}
\\ &
     \ensuremath{{\Conid{C}}^{*}\times\Conid{S}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{zed}\mathrel{=}\conj{\conj{\p1\comp \p1}{\p2}}{\p2\comp \p1}{}\<[E]%
\\
\>[B]{}\Varid{myMapAccumR2}\;\Varid{f}\mathrel{=}(\Varid{cons}\times\Varid{id})\comp \Varid{zed}\comp \conj{\Varid{f}\comp (\Varid{id}\times\p2)}{\p1\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
e tambem podemos definir \ensuremath{\Varid{zed}} como \ensuremath{\Varid{zed}\mathrel{=}\Varid{assocl}\comp (\Varid{id}\times\Varid{swap})\comp \Varid{assocr}} e
\ensuremath{\conj{\Varid{f}\comp (\Varid{id}\times\p2)}{\p1\comp \p2}} como \ensuremath{(\Varid{f}\times\Varid{id})\comp \Varid{assocl}\comp (\Varid{id}\times\Varid{swap})}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{myMapAccumR}\;\Varid{f}\mathrel{=}\llparenthesis\, \alt{\Varid{myMapAccumR1}}{\Varid{myMapAccumR2}\;\Varid{f}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outListAcc'}\;([\mskip1.5mu \mskip1.5mu],\Varid{s})\mathrel{=}i_1\;((),\Varid{s}){}\<[E]%
\\
\>[B]{}\Varid{outListAcc'}\;(\Varid{x},\Varid{s}){}\<[21]%
\>[21]{}\mathrel{=}i_2\;(\Varid{last}\;\Varid{x},(\Varid{init}\;\Varid{x},\Varid{s})){}\<[E]%
\\
\>[B]{}\llparenthesis\, \Varid{g}\,\rrparenthesis\mathrel{=}\Varid{g}\comp \Varid{recList}\;\llparenthesis\, \Varid{g}\,\rrparenthesis\comp \Varid{outListAcc'}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{addToLast}\mathrel{=}\uncurry{(\Varid{flip}\;(\mathbin{+\!\!+})\comp (\Varid{singl}))}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myMapAccumL1}\mathrel{=}\Varid{nil}\times\Varid{id}{}\<[E]%
\\
\>[B]{}\Varid{myMapAccumL2}\;\Varid{f}\mathrel{=}(\Varid{addToLast}\times\Varid{id})\comp \Varid{zed}\comp \conj{\Varid{f}\comp (\Varid{id}\times\p2)}{\p1\comp \p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{myMapAccumL}\;\Varid{f}\mathrel{=}\llparenthesis\, \alt{\Varid{myMapAccumL1}}{\Varid{myMapAccumL2}\;\Varid{f}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
como estamos começar pelo fim, então também temos de começar a adicionar os
elementos pelo fim.

E segue-se o diagrama do \ensuremath{\Varid{filter}} e o seu catamorfismo:
\begin{eqnarray*}
\xymatrix@C=4cm{
    \ensuremath{{\Conid{A}}^{*}}
           \ar[d]_-{\ensuremath{\Varid{myfilter}\;\Varid{p}}}
           \ar[r]^-{\ensuremath{\Varid{outList}}}
&
    \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{\Conid{A}}^{*}}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}(\Varid{myfilter}\;\Varid{p})}}
\\
     \ensuremath{{\Conid{A}}^{*}}
&
     \ensuremath{\mathrm{1}\mathbin{+}\Conid{A}\times{\Conid{A}}^{*}}
           \ar[l]^-{\ensuremath{\alt{\Varid{nil}}{\Varid{cond}\;(\Varid{p}\comp \p1)\;\Varid{cons}\;\p2}}}
}
\end{eqnarray*}
\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{myfilter}\;\Varid{p}\mathrel{=}\llparenthesis\, \alt{\Varid{nil}}{\Varid{cond}\;(\Varid{p}\comp \p1)\;\Varid{cons}\;\p2}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\newpage
\noindent
Agora podemos definir \ensuremath{\Varid{mapAccumRfilter}} e \ensuremath{\Varid{mapAccumLfilter}}
inspirado nas as funções anteriores
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{{\Conid{A}}^{*}\times\Conid{S}}
           \ar[d]_-{\ensuremath{\Varid{mapAccumRfilter}\;\Varid{p}\;\Varid{f}}}
           \ar[r]_-{\ensuremath{\Varid{outListAcc}}}
&
    \ensuremath{(\mathrm{1}\times\Conid{S})\mathbin{+}\Conid{A}\times({\Conid{A}}^{*}\times\Conid{S})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times(\Varid{mapAccumRfilter}\;\Varid{p}\;\Varid{f})}}
\\
     \ensuremath{{\Conid{C}}^{*}\times\Conid{S}}
&
     \ensuremath{(\mathrm{1}\times\Conid{S})\mathbin{+}\Conid{A}\times({\Conid{C}}^{*}\times\Conid{S})}
...
\end{eqnarray*}
\ensuremath{\Varid{mapAccumRfilter}\;\Varid{p}\;\Varid{f}\mathrel{=}\llparenthesis\, \alt{\Varid{mapAccumRfilter1}}{\Varid{mapAccumRfilter2}\;\Varid{p}\;\Varid{f}}\,\rrparenthesis}

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mapAccumRfilter1}\mathrel{=}\Varid{nil}\times\Varid{id}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mapAccumRfilter2}\;\Varid{p}\;\Varid{f}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\alt{(\Varid{cons}\times\Varid{id})\comp \Varid{zed}}{\Varid{swap}\comp (\p2\times\Varid{id})}\comp ((\Varid{f}\times\Varid{id})+(\Varid{f}\times\Varid{id}))\comp (\Varid{grd}\;(\Varid{p}\comp \p1))\comp \Varid{assocl}\comp (\Varid{id}\times\Varid{swap}){}\<[E]%
\\
\>[B]{}\Varid{mapAccumRfilter}\;\Varid{p}\;\Varid{f}\mathrel{=}\llparenthesis\, \alt{\Varid{mapAccumRfilter1}}{\Varid{mapAccumRfilter2}\;\Varid{p}\;\Varid{f}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks

\noindent
e podemos ver que, \ensuremath{\alt{(\Varid{cons}\times\Varid{id})\comp \Varid{zed}}{\Varid{swap}\comp (\p2\times\Varid{id})}} 
e \ensuremath{\alt{\Varid{cons}}{\p2}} são similares.

\noindent
Análogamente podemos fazer o \ensuremath{\Varid{mapAccumLfilter}}, com o mesmo funtor do
\ensuremath{\Varid{myMapAccumL}}

\begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{6}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{mapAccumLfilter1}\mathrel{=}\Varid{nil}\times\Varid{id}{}\<[E]%
\\
\>[B]{}\Varid{mapAccumLfilter2}\;\Varid{p}\;\Varid{f}\mathrel{=}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\alt{(\Varid{addToLast}\times\Varid{id})\comp \Varid{zed}}{\Varid{swap}\comp (\p2\times\Varid{id})}\comp ((\Varid{f}\times\Varid{id})+(\Varid{f}\times\Varid{id}))\comp (\Varid{grd}\;(\Varid{p}\comp \p1))\comp \Varid{assocl}\comp (\Varid{id}\times\Varid{swap}){}\<[E]%
\\
\>[B]{}\Varid{mapAccumLfilter}\;\Varid{p}\;\Varid{f}\mathrel{=}\llparenthesis\, \alt{\Varid{mapAccumLfilter1}}{\Varid{mapAccumLfilter2}\;\Varid{p}\;\Varid{f}}\,\rrparenthesis{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{calc}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{/}(\mathrm{4}\mathbin{*}\Varid{n}\mathbin{-}\mathrm{3}){}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{add}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{x}\mathbin{+}\Varid{y}{}\<[E]%
\\
\>[B]{}\hsindent{6}{}\<[6]%
\>[6]{}\Varid{mul}\;(\Varid{x},\Varid{y})\mathrel{=}\Varid{x}\mathbin{*}\Varid{y}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{inic}\mathrel{=}(\mathrm{1},(\mathrm{1}\mathbin{/}\mathrm{3},\mathrm{2}\mathbin{/}\mathrm{5})){}\<[E]%
\\[\blanklineskip]%
