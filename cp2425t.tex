...
Reparemos que
\begin{eqnarray*}
	\ensuremath{\pi }_n = \sum_{i=0}^n \frac{(i!)^2 {2^{i+1}}}{(2i+1)!} = 2\sum_{i=0}^n \frac{(i!) \times (i!){2^{i}}}{(2i+1)!}  =  2\sum_{i=0}^n \frac{i! \times (2\cdot i \times 2\cdot (i-1) \times \dots \times 2 \cdot 2 \times 2\cdot 1)}{(2i+1)\times (2i)\times \dots \times 2 \times 1} = \\ =2\sum_{i=0}^n \frac{i!}{(2i+1)!!}  
\end{eqnarray*}
...
\\
\>[B]{}\Varid{g}\comp \mathsf{in}\mathrel{=}\alt{\underline{\mathrm{1}\mathbin{/}\mathrm{3}}}{\Varid{mul}}\comp (\mathrm{1}\mathbin{+}\conj{\Varid{g}}{\Varid{t}}){}\<[E]%
\\
\>[B]{}\Varid{h}\comp \mathsf{in}\mathrel{=}\alt{\underline{\mathrm{2}\mathbin{/}\mathrm{5}}}{\Varid{calc}}\comp (\mathrm{1}\mathbin{+}\Varid{t})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{f}\comp \mathsf{in}\mathrel{=}\alt{\underline{\mathrm{1}}}{\Varid{add}\comp \p1\comp \Varid{assocl}}\comp (\mathrm{1}\mathbin{+}\conj{\Varid{f}}{\conj{\Varid{g}}{\Varid{t}}}){}\<[E]%
\\
\>[B]{}\Varid{g}\comp \mathsf{in}\mathrel{=}\alt{\underline{\mathrm{1}\mathbin{/}\mathrm{3}}}{\Varid{mul}\comp \p2}\comp (\mathrm{1}\mathbin{+}\conj{\Varid{f}}{\conj{\Varid{g}}{\Varid{t}}}){}\<[E]%
\\
\>[B]{}\Varid{h}\comp \mathsf{in}\mathrel{=}\alt{\underline{\mathrm{2}\mathbin{/}\mathrm{5}}}{\Varid{calc}\comp \p2\comp \p2}\comp (\mathrm{1}\mathbin{+}\conj{\Varid{f}}{\conj{\Varid{g}}{\Varid{t}}})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{calc}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{/}(\mathrm{4}\mathbin{*}\Varid{n}\mathbin{-}\mathrm{3}){}\<[E]%
\\
...
\>[100]{}\comp (\mathrm{1}\mathbin{+}\conj{\Varid{f}}{\conj{\Varid{g}}{\Varid{t}}})\;\mathbf{where}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\Varid{calc}\;\Varid{n}\mathrel{=}(\Varid{n}\mathbin{-}\mathrm{1})\mathbin{/}(\mathrm{4}\mathbin{*}\Varid{n}\mathbin{-}\mathrm{3}){}\<[E]%
\\
